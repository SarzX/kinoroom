...
const OurHalls = () => {
    const cards = [
        ...
        },
        {
            ...
            title: 'Все условия для ваших любовных утех',
            subtitle: 'Мы создадим все условия чтобы вам было приятно заниматься интимом, доступны презервативы и смазки за доп оплату',
        },
    ]
    return (
